...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2021 at 04:24 PM
...
INSERT INTO `dat_uss` (`id`, `nama`, `username`, `password`, `levl`, `bagian`, `type`, `gamb`) VALUES
(1, 'Audmeinz', 'admin', '123456', 'admin', '', '', ''),
(2, 'opera', 'ope', '12345', 'operator', 'GA', 'stok', 'log1.jpg'),
(3, 'pengun', 'visitor', '1234', 'visitor', 'ARM', 'stok', 'log2.jpg'),
(4, 'jemes bond', '007', '130596', 'sudo', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `stok_databarang`
--

CREATE TABLE `stok_databarang` (
  `id` int(225) NOT NULL,
  ...
  `milik` varchar(225) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `stok_databarang`
--

INSERT INTO `stok_databarang` (`id`, `id_barang`, `nama_barang`, `merk`, `kategori`, `harga_beli`, `harga_jual`, `stok`, `keterangan`, `acc`, `tanggal_ket`, `milik`) VALUES
(1, '1534651000001', '-', '-', 'A', '250000', '0', '11', '', 'pengun', '2021-06-07', 'ARM'),
(2, '1562315000012', 'SOKLE', 'PHILIP', 'LAMPU', '125000', '0', '15', '', 'pengun', '2021-06-07', 'ARM'),
(3, '16448512300001', 'BATREPOL', 'ALKALIN', 'AKI', '250000', '0', '15', '', 'pengun', '2021-06-07', 'ARM'),
(4, '16978542100012', 'BAN SAMPING', 'DUNLOP', 'BAN', '1250000', '0', '4', '', 'pengun', '2021-06-07', 'ARM');

-- --------------------------------------------------------

--
-- Table structure for table `stok_isibeli`
--

CREATE TABLE `stok_isibeli` (
  `id` int(225) NOT NULL,
  `nota` varchar(225) NOT NULL,
...
--
-- Dumping data for table `stok_isibeli`
--

INSERT INTO `stok_isibeli` (`id`, `nota`, `kode_barang`, `nama`, `harga`, `jumlah`, `total`, `tgl`, `keterangan`, `acc`, `milik`) VALUES
(2, 'NP/ARM2106070001', '1534651000001', '-', '250000', '5', '1250000', '2021-06-07', '', 'pengun', 'ARM'),
(3, 'NP-ARM210607-0001', '1562315000012', 'SOKLE', '125000', '15', '1875000', '2021-06-07', '', 'pengun', 'ARM'),
(4, 'NP-ARM210607-0001', '16978542100012', 'BAN SAMPING', '1250000', '4', '5000000', '2021-06-07', '', 'pengun', 'ARM'),
(5, 'NP-ARM210607-0001', '16448512300001', 'BATREPOL', '250000', '15', '3750000', '2021-06-07', '', 'pengun', 'ARM'),
(6, 'NP-ARM210607-0001', '1534651000001', '-', '250000', '6', '1500000', '2021-06-07', '', 'pengun', 'ARM');

-- --------------------------------------------------------

--
-- Table structure for table `stok_kategor`
--

CREATE TABLE `stok_kategor` (
  `id` int(225) NOT NULL,
  `nama` varchar(225) NOT NULL,
  `milik` varchar(225) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `stok_kategor`
--

INSERT INTO `stok_kategor` (`id`, `nama`, `milik`) VALUES
(4, 'LAMPU', 'ARM'),
(5, 'BAN', 'ARM'),
(6, 'SPION', 'ARM'),
(7, 'AKI', 'ARM');
...
--
-- Table structure for table `stok_lapbeli`
--

CREATE TABLE `stok_lapbeli` (
  `id` int(225) NOT NULL,
  `nota` varchar(225) NOT NULL,
  `nopol` varchar(225) NOT NULL,
  `tgl` date NOT NULL,
...
--
-- Dumping data for table `stok_lapbeli`
--

INSERT INTO `stok_lapbeli` (`id`, `nota`, `nopol`, `tgl`, `harga_total`, `jumlah`, `keterangan`, `stat`, `acc`, `milik`) VALUES
(1, 'SRV-ARM210607/0001', 'B 48511 OP', '2021-06-07', '', '', '', '', 'pengun', 'ARM'),
(2, 'NP/ARM2106070001', '', '2021-06-07', '1250000', '1', '', '', 'pengun', 'ARM'),
(3, 'NP-ARM210607-0001', '', '2021-06-07', '12125000', '4', '', '', 'pengun', 'ARM'),
(4, 'SRV-ARM210607-0002', 'B 48511 OP', '2021-06-07', '', '', '', '', 'pengun', 'ARM');

-- --------------------------------------------------------

--
-- Table structure for table `stok_member`
--

CREATE TABLE `stok_member` (
  `id` int(225) NOT NULL,
  `nopol` varchar(225) NOT NULL,
  `nomesin` varchar(225) NOT NULL,
  `merk` varchar(225) NOT NULL,
  `jenis` varchar(225) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `stok_member`
--

INSERT INTO `stok_member` (`id`, `nopol`, `nomesin`, `merk`, `jenis`) VALUES
(1, 'B 48511 OP', '314594510111', 'DAIHATSU', 'MBIL PENUMPANG');
...
--
-- Indexes for table `stok_databarang`
--
ALTER TABLE `stok_databarang`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `stok_isibeli`
--
ALTER TABLE `stok_isibeli`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `stok_kategor`
--
ALTER TABLE `stok_kategor`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `stok_lapbeli`
--
ALTER TABLE `stok_lapbeli`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `stok_member`
--
ALTER TABLE `stok_member`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `stok_databarang`
--
ALTER TABLE `stok_databarang`
  MODIFY `id` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `stok_isibeli`
--
ALTER TABLE `stok_isibeli`
  MODIFY `id` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `stok_kategor`
--
ALTER TABLE `stok_kategor`
  MODIFY `id` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `stok_lapbeli`
--
ALTER TABLE `stok_lapbeli`
  MODIFY `id` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `stok_member`
--
ALTER TABLE `stok_member`
