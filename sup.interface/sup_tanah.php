...
?>
	<tr>
		<form method="POST" action="updell.php">
			...
			<td class="d-flex">
				<button class="btn btn-warning btn-sm ml-1" name="smp"><span class="ti-save"></span></button>
				<button class="btn btn-danger btn-sm ml-1" name="delt"><span class="ti-trash"></span></button>
			</td>
		</form>
	</tr>
