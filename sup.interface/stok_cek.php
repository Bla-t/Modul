  ...
  <div class="activity-card">
    <div class="row">
      <div class="form-inline d-flex">
        <h4>Edit Stok GA || </h4>
        <a href="editlaporan_beli.php" class="btn btn-warning btn-sm ml-2 mb-2">Laporan Beli</a>
            ...
            ?>
              <form action="updell.php" method="POST">
                <tr class="align-conten-center">
                  ...
                  <td class="kolm"><input class="form-control form-control-sm" type="text" name="stoks" value="<?= $tulis['stok'] ?>"></td>
                  <td><?= $tulis['milik'] ?></td>
                  <td class="d-flex">
