	...
	?>
		<div class="activity-card">
			<div class="form-inline" style="border-bottom: 2px solid #D5D8DC;">
				<h4><img src="gamb_user/<?php echo $gam; ?>" class="profgam" alt="gambar">Profil | "<?php echo $cek['nama']; ?>"</h4>
			</div>
			<?php
			...
			<form method="POST" action="" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="form-inline">
						...
						<button class="btn btn-danger" id="simpan_profil" name="Simpan_propil" value="<?php echo $cek['id']; ?>">Simpan</button>
					</div>
				</div>
			<?php
		}
		...
		if (isset($_POST['Simpan_propil'])) {
			...
			echo "<script>window.location.href='home.php?ow=yeah';</script>";
			exit;
		}
			?>
			</form>
