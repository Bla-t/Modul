  ...
  <div class="card">
    ...
    ?>
        ...
        <form action="" method="POST">
          <input type="hidden" value="<?= $_GET['kls']; ?>" name="klas">
          <div class="row">
          ...
          <div class="row">
            <div class="col">
              <a href="gol-tunjangan.php" class="btn btn-info btn-sm">batal</a>
          ...
          if (isset($_POST['eksek'])) {
            ...
            $b = $_POST['gol1'];
            $milk = $_POST['klas'];
            mysqli_query($conn, "INSERT INTO `$data`(`$judul`,`$judul2`,`tipe`) VALUES ('$a','$b','$milk')") or die(mysqli_error($conn));
            echo "<script>window.location.href='gol-tunjangan.php?ow=yeah';</script>";
          }
          ?>
        </form>
      <?php
    ...
    <?php
      ...
      case 'hapus':
        ...
        echo "<script>window.location.href='gol-tunjangan.php?ow=ded&&id=" . $id . "'</script>";
        break;
    }
